       ...
       <div className="box_left">
        <div className="users_box_wrapper1">
          ...
          <div className="box box2 ">
             <span>
                ...
                <p className="p2">{selectedItem.individual.prefix_data.desc ?? "---"}</p>
             </span>
             <span>
                <p className="p1">First Name</p> 
                <p className="p2">{selectedItem.individual.first_name ?? "---"}</p>
             </span>

             <span>
                <p className="p1">Middle Name</p> 
                <p className="p2">{selectedItem.individual.middle_name  ?? "---"}</p>
             </span>
             <span>
                <p className="p1">Last Name</p> 
                <p className="p2">{selectedItem.individual.last_name ?? "---" }</p>
             </span>
             <span>
                <p className="p1">Suffix</p> 
                <p className="p2">{selectedItem.individual.suffix_data.desc ?? "---" }</p>
             </span>
             <span>
                <p className="p1">Nickname</p> 
                <p className="p2">{selectedItem.individual.nickname ?? "---" }</p>
             </span>
          </div>
        </div>
        <div className="users_box_wrapper1 pt-6">
          ...
          <span>
                ...
                <p className="p2">{selectedItem.individual.user_id ?? "---"}</p>
             </span>
             <span>
