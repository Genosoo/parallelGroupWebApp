...
export default function Account() {
  ...
  return (
    <div className="flex items-center bg-[#EBF4FD] p-10 hg flex-col h-[100vh]  gap-3 font-manrope">
                ...
                {successMessage && <p className="text-green-500">{successMessage}</p>}
                 ...
                 <div className="flex  flex-col gap-2">
                      <span className="flex gap-3  p-3 rounded-[10px] bg-white">First name:
                       ...
                       <span className="flex gap-3  p-3 rounded-[10px] bg-white">Mobile Number:
                       <p className="font-bold text-gray-600">{mobileNumber}</p>
                       </span>

                       
                       <span className="flex gap-3  p-3 rounded-[10px] bg-white">Birth of Date:
                       <p className="font-bold text-gray-600">{birthDate}</p>
                       </span>

                       <span className="flex gap-3  p-3 rounded-[10px] bg-white">Gender:
